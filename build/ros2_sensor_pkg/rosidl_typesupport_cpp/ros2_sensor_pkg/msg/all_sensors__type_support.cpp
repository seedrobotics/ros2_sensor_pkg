...
static const _AllSensors_type_support_symbol_names_t _AllSensors_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_sensor_pkg, msg, AllSensors)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_sensor_pkg, msg, AllSensors)),
  }
};
...
{
  return &::ros2_sensor_pkg::msg::rosidl_typesupport_cpp::AllSensors_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_sensor_pkg, msg, AllSensors)() {
  return get_message_type_support_handle<ros2_sensor_pkg::msg::AllSensors>();
}
