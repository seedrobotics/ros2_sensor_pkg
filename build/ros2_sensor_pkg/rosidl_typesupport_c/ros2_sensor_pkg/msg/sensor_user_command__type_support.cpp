...
static const _SensorUserCommand_type_support_symbol_names_t _SensorUserCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_sensor_pkg, msg, SensorUserCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_sensor_pkg, msg, SensorUserCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_sensor_pkg, msg, SensorUserCommand)() {
  return &::ros2_sensor_pkg::msg::rosidl_typesupport_c::SensorUserCommand_message_type_support_handle;
}
